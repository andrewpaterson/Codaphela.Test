...
void TestIndexedDataSimple(EIndexWriteThrough eWriteThrough)
{
	...
	cIndexConfig.Init(szSubDirectory, 8 KB, 8 KB, eWriteThrough, &cEvictionStrategy);
	cController.Begin();
...
void TestIndexedDataFlushClearCache(void)
{
	...
	cEvictionStrategy.Init();
	cController.Init(szDirectory, NULL);
	cIndexConfig.Init(NULL, 8 KB, 8 KB, IWT_No, &cEvictionStrategy);
	cController.Begin();
	cIndexedData.Init(&cController, &cIndexConfig);
	cController.End();
	...
	cEvictionStrategy.Init();
	cController.Init(szDirectory, NULL);
	cIndexConfig.Init(NULL, 1 MB, 1 MB, IWT_No, &cEvictionStrategy);
	cController.Begin();
	cIndexedData.Init(&cController, &cIndexConfig);
	cController.End();
...
void TestIndexedDataIndexEviction(void)
{
	...
	cController.Init(szDirectory, NULL);
	cIndexConfig.Init(NULL, 1024, 3570, IWT_No, &cEvictionStrategy, &cIndexEvictedList, &cKeyDataEvictedList);  //A little more than two items in the cache...
	cController.Begin();
	cIndexedData.Init(&cController, &cIndexConfig);
	cController.End();
	...
	AssertLongLongInt(4LL, *((int64*)(cIndexEvictedList.GetKey(0))));
	Pass();
...
void TestIndexedDataLargeData(void)
{
	...
	cEvictionStrategy.Init();
	cController.Init(szDirectory, NULL);
	cIndexConfig.Init(NULL, 34, 8 KB, IWT_No, &cEvictionStrategy);
	cController.Begin();
	cIndexedData.Init(&cController, &cIndexConfig);
	cController.End();
	OI = 4LL;
...
void TestIndexedDataIndexedAdd(void)
{
	...
	cEvictionStrategy.Init();
	cController.Init(szDirectory, NULL);
	cIndexConfig.Init(NULL, 98 + 12, 8 KB, IWT_No, &cEvictionStrategy);
	cController.Begin();
	cIndexedData.Init(&cController, &cIndexConfig);
	cController.End();
...
void TestIndexedDataDescriptorCaching(void)
{
	...
	cController.Init(szDirectory, NULL);
	cIndexConfig.Init(NULL, 8 KB, 3650, IWT_No, &cEvictionStrategy, &cIndexTreeEvictedList, &cIndexedDataEvictedList);
	cController.Begin();
	cIndexedData.Init(&cController, &cIndexConfig);
	cController.End();
	...
	AssertInt(77, iData);
	AssertInt(0, cIndexedDataEvictedList.NumElements());
	AssertInt(3584, cIndexedData.GetIndiciesSystemMemorySize());
	...
	AssertLongLongInt(2LL, cIndexedDataEvictedList.GetKey(0));
	...
	AssertInt(3620, cIndexedData.GetIndiciesSystemMemorySize());
	cIndexedDataEvictedList.Clear();
	cIndexTreeEvictedList.Clear();

	cIndexedData.Add(OI, &iData, 4); OI++;  iData++;
	AssertInt(1, cIndexedDataEvictedList.NumElements());
	AssertLongLongInt(5LL, cIndexedDataEvictedList.GetKey(0));
	...
	cEvictionStrategy.Init();
	cController.Init(szDirectory, NULL);
	cIndexConfig.Init(NULL, 96, 8 KB, IWT_No, &cEvictionStrategy);
	cController.Begin();
	cIndexedData.Init(&cController, &cIndexConfig);
	cController.End();
...
void TestIndexedDataNoCaching(void)
{
	...
	cEvictionStrategy.Init();
	cController.Init(szDirectory, NULL);
	cIndexConfig.Init(NULL, 0, 3670, IWT_No, &cEvictionStrategy);
	cController.Begin();
	cIndexedData.Init(&cController, &cIndexConfig);
	cController.End();
...
void TestIndexedDataSubDirectories(void)
{
	...
	cIndexConfig.Init("Forest of Solitude", 8 KB, 8 KB, IWT_No, &cEvictionStrategy);
	cController.Begin();
	cIndexedData.Init(&cController, &cIndexConfig);
	cController.End();
...
void TestIndexedDataRemove(EIndexWriteThrough eWriteThrough)
{
	...
	cEvictionStrategy.Init();
	cController.Init(szDirectory, NULL);
	cIndexConfig.Init(NULL, 8 KB, 8 KB, eWriteThrough, &cEvictionStrategy);
	cController.Begin();
	cIndexedData.Init(&cController, &cIndexConfig);
	cController.End();
