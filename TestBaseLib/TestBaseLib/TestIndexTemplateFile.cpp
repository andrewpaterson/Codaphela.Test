...
void TestIndexTreeTemplateFileStuff(void)
{
	...
	AssertTrue(cAccess.PutKeyData(cObject1.GetName(), cObject1.NameLength(), &cObject1, sizeof(CTestIndexTreeObject2)));
	AssertTrue(cAccess.PutKeyData(cObject2.GetName(), cObject2.NameLength(), &cObject2, sizeof(CTestIndexTreeObject2)));
