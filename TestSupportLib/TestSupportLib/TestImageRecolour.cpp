...
void TestImageRecolour1(void)
{
	...
	Ptr<CImage> pcImage = ReadImage("Input" _FS_ "recolour.png");
	cRect.Init(0, 4, 8, 8);
	...
	WriteImage(pcImage, "Output" _FS_ "recolour.raw");
	AssertFileMemory("input" _FS_ "recolour.raw", pcImage->GetData(), pcImage->GetByteSize());
