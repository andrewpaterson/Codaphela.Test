...
//	AssertLongLongInt(1, pcDatabase->NumIndicesCached(106));
//	AssertLongLongInt(0, pcDatabase->NumIndicesCached(118));
//
//	bResult = gcObjects.Save(pDouble.BaseObject());
//	AssertTrue(bResult);
//	AssertLongLongInt(1, pcDatabase->NumIndices());
...
//	AssertLongLongInt(0, pcDatabase->NumIndicesCached(106));
//	AssertLongLongInt(1, pcDatabase->NumIndicesCached(118));
//
//	pDouble->mszString = OMalloc(CString);
